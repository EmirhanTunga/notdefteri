        ...
        <div class="container">
            ...
            <form id="noteForm" method="POST" action="save_note.php" enctype="multipart/form-data">
                ...
                <div class="color-picker">
                    <label>Renk:</label>
                    <label class="color-radio yellow"><input type="radio" name="color" value="yellow" checked><span></span></label>
                    <label class="color-radio blue"><input type="radio" name="color" value="blue"><span></span></label>
                    <label class="color-radio green"><input type="radio" name="color" value="green"><span></span></label>
                    <label class="color-radio pink"><input type="radio" name="color" value="pink"><span></span></label>
                </div>
